...
<body>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="buy-tickets"><a href="regist.php">Registration</a></li>
        </ul>
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      <h1 class="mb-4 pb-0">International<br><span>Accuntantion</span> Conference</h1>
      <p class="mb-4 pb-0">10-12 December, Muhammadiyah Bandung University, Bandung</p>
